                                                ...
                                                <table id="data-table-basic" class="table table-striped">
                                                    ...
                                                    <tbody>
                                                     ...
                                                     while($data = mysqli_fetch_array($result)) {
                                                        ...
                                                        echo "<td><a href='detailHasilLatihan.php?id=$data[nama_latihan]'><button title='detail' class='btn btn-info btn-sm fa fa-info'> detail </button>
                                                        <button title='hapus' class='btn btn-danger btn-sm fa fa-trash'><a href='deleteHasilLatihan.php?id=$data[nama_latihan]'> hapus </button></td>";
                                                        echo"</tr>";
                                                    }
                                                    ?>
                                                </tfoot>
