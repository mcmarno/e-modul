...
$nama = $_GET['id'];
$result = mysqli_query($conn, "SELECT * FROM hasil WHERE nama_tugas = '$nama'");
                                                ...
                                                <table id="data-table-basic" class="table table-striped">
                                                    ...
                                                    <tbody>
                                                     ...
                                                     while($data = mysqli_fetch_array($result)) {
                                                        ...
                                                        echo "<td><a href='detailLaporan.php?id=$data[id_hasil]'><button title='unduh' class='btn btn-info btn-sm fa fa-download'> pdf </button>
                                                        <button title='hapus' class='btn btn-danger btn-sm fa fa-trash'><a href='deleteLaporan.php?id=$data[id_hasil]'> hapus </button></td>";
                                                        echo"</tr>";
                                                    }
                                                    ?>
                                                </tfoot>
