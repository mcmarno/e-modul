...
include("config.php");
$id = $_GET['id'];
$query = mysqli_query($conn, "SELECT * FROM latihan WHERE id_latihan = $id");
                            ...
                            <div class="col-md-12">
                                <div class="card card-block sameheight-item">
                                    <div class="title-block">
                                        <h3 class="title"> Edit Data Latihan </h3>
                                    </div>
                                    <form id="tambah-form" action="prosesEditLatihan.php" method="POST" enctype="multipart/form-data">
                                        <div>
                                            <input type="hidden" name="id_latihan" value="<?php echo $data['id_latihan'] ?>">
                                        </div>
                                        <div class="form-group">
                                            <label class="control-label">Nama</label>
                                            <input type="text" class="form-control underlined" name="nama_latihan" value="<?php echo $data['nama_latihan'] ?>"></div>
                                        <div class="form-group">
                                            <label class="control-label">Isi</label>
                                            <textarea id="summernote" name="isi"><?php echo $data['isi'] ?></textarea></div>
