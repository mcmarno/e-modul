...
$result = mysqli_query($conn, "SELECT * FROM tugas ORDER BY nama_tugas ASC");
                                                ...
                                                <table id="data-table-basic" class="table table-striped">
                                                    ...
                                                    <tbody>
                                                     ...
                                                     while($data = mysqli_fetch_array($result)) {
                                                        ...
                                                        echo "<td><a href='detailHasil.php?id=$data[nama_tugas]'><button title='edit' class='btn btn-info btn-sm fa fa-info'> detail </button>
                                                        <button title='hapus' class='btn btn-danger btn-sm fa fa-trash'><a href='deleteHasil.php?id=$data[nama_tugas]'> hapus </button></td>";
                                                        echo"</tr>";
                                                    }
                                                    ?>
                                                </tfoot>
