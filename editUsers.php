...
$query = "SELECT * FROM users WHERE id_user = '$id'";  //get the data that will be updated
                                ...
                                <div class="card card-block sameheight-item">
                                    ...
                                    <form id="tambah-form" action="prosesEditUsers.php" method="POST">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control underlined" name="username" value="<?php echo $data['username'] ?>" readonly="readonly"></div>
                                        <div class="form-group">
                                            <label class="control-label">Password</label>
                                            <input type="text" class="form-control underlined" name="password"></div>
