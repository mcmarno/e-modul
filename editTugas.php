                            ...
                            <div class="col-md-12">
                                <div class="card card-block sameheight-item">
                                    <div class="title-block">
                                        <h3 class="title"> Edit Data Tugas </h3>
                                    </div>
                                    <form id="tambah-form" action="prosesEditTugas.php" method="POST" enctype="multipart/form-data">
                                        <div>
                                            <input type="hidden" name="id_tugas" value="<?php echo $data['id_tugas'] ?>">
                                        </div>
                                        <div class="form-group">
                                            <label class="control-label">Nama</label>
                                            <input type="text" class="form-control underlined" name="nama_tugas" value="<?php echo $data['nama_tugas'] ?>"></div>
                                        <div class="form-group">
