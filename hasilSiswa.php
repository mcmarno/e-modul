                            ...
                            <div class="col-md-6">
                                <div class="card card-block sameheight-item">
                                    <div class="title-block">
                                        <h3 class="title"> Upload Hasil Tugas </h3>
                                    </div>
                                    <form id="tambah-form" action="prosesTambahHasilSiswa.php" method="POST" enctype="multipart/form-data">
                                        <?php
                                        ...
                                        <div class="">
                                            <label class="control-label">Pilih tugas</label></div>
                                        <div class="form-group">
                                            <select name="nama_tugas">
                                                <?php if (mysqli_num_rows($result) > 0) { 
                                                    while ($data = mysqli_fetch_array($result)) {?>
                                                        <option> <?php echo $data['nama_tugas'] ?></option>
                                                        <?php
                                                        }
                                                    }
                                                        ?>
