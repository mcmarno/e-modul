                            ...
                            <div class="col-md-12">
                                <div class="card card-block sameheight-item">
                                    <div class="title-block">
                                        <h3 class="title"> Tambah Data Latihan </h3>
                                    </div>
                                    <form id="tambah-form" action="prosesTambahLatihan.php" method="POST">
                                        <div class="form-group">
                                            <label class="control-label">Nama</label>
                                            <input type="text" class="form-control underlined" name="nama_latihan" ></div>
                                        <div class="form-group">
