...
$result = mysqli_query($conn, "SELECT * FROM latihan ORDER BY id_latihan ASC");
                                    ...
                                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                        <div class="data-table-list">
                                            <div class="basic-tb-hd">
                                                <h3>Data Latihan</h3>
                                                <a href="tambahLatihan.php"><button class="btn btn-success fa fa-plus" title="tambah"> tambah latihan</button></a>
                                            </div>
                                                ...
                                                <table id="data-table-basic" class="table table-striped">
                                                    ...
                                                    <tbody>
                                                     ...
                                                     while($data = mysqli_fetch_array($result)) {
                                                        ...
                                                        echo "<td><a href='detailLatihan.php?id=$data[id_latihan]'><button title='detail' class='btn btn-primary btn-sm fa fa-info'> detail </button>
                                                        <a href='editLatihan.php?id=$data[id_latihan]'><button title='edit' class='btn btn-warning btn-sm fa fa-edit'> edit </button>
                                                        <button title='hapus' class='btn btn-danger btn-sm fa fa-trash'><a href='deleteLatihan.php?id=$data[id_latihan]'> hapus </button></td>";
                                                        echo"</tr>";
                                                    }
                                                    ?>
                                                </tfoot>
