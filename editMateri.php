                            ...
                            <div class="col-md-12">
                                <div class="card card-block sameheight-item">
                                    <div class="title-block">
                                        <h3 class="title"> Edit Data Materi </h3>
                                    </div>
                                    <form id="tambah-form" action="prosesEditMateri.php" method="POST" enctype="multipart/form-data">
                                        <div>
                                            <input type="hidden" name="id_materi" value="<?php echo $data['id_materi'] ?>">
                                        </div>
                                        <div class="form-group">
                                            <label class="control-label">Judul</label>
                                            <input type="text" class="form-control underlined" name="judul" value="<?php echo $data['nama'] ?>"></div>
                                        <div class="form-group">
                                            <label class="control-label">Isi</label>
                                            <textarea id="summernote" name="text"><?php echo $data['isi'] ?></textarea></div>
