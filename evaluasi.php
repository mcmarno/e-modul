                                    ...
                                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                        <div class="data-table-list">
                                            <div class="basic-tb-hd">
                                                <h3>Data Evaluasi</h3>
                                                <a href="tambahEvaluasi.php"><button class="btn btn-success fa fa-plus" title="tambah"> tambah evaluasi</button></a>
                                            </div>
                                                ...
                                                <table id="data-table-basic" class="table table-striped">
                                                    ...
                                                    <tbody>
                                                     ...
                                                     while($data = mysqli_fetch_array($result)) {
                                                        ...
                                                        echo "<td><a href='detailEvaluasi.php?id=$data[kode_soal]'><button title='detail' class='btn btn-primary btn-sm fa fa-info'> detail </button>
                                                        <a href='editEvaluasi.php?id=$data[kode_soal]'><button title='edit' class='btn btn-warning btn-sm fa fa-edit'> edit </button>
                                                        <button title='hapus' class='btn btn-danger btn-sm fa fa-trash'><a href='deleteEvaluasi.php?id=$data[kode_soal]'> hapus </button></td>";
                                                        echo"</tr>";
                                                    }
                                                    ?>
                                                </tfoot>
