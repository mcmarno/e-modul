...
$result = mysqli_query($conn, "SELECT * FROM siswa ORDER BY id_siswa ASC");
                                    ...
                                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                        <div class="data-table-list">
                                            <div class="basic-tb-hd">
                                                <h3>Data Siswa</h3>
                                                <a href="tambahSiswa.php"><button class="btn btn-success fa fa-plus" title="tambah"> tambah siswa</button></a>
                                            </div>
                                                ...
                                                <table id="data-table-basic" class="table table-striped">
                                                    ...
                                                    <tbody>
                                                     ...
                                                     while($data = mysqli_fetch_array($result)) {
                                                        ...
                                                        <button title='hapus' class='btn btn-danger btn-sm fa fa-trash'><a href='deleteSiswa.php?id=$data[id_siswa]'> hapus </button></td>";
                                                        echo"</tr>";
                                                    }
                                                    ?>
                                                </tfoot>
