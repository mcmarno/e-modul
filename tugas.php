...
$result = mysqli_query($conn, "SELECT * FROM tugas ORDER BY id_tugas ASC");
                                    ...
                                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                        <div class="data-table-list">
                                            <div class="basic-tb-hd">
                                                <h3>Data Tugas</h3>
                                                <a href="tambahTugas.php"><button class="btn btn-success fa fa-plus" title="tambah"> tambah tugas</button></a>
                                            </div>
                                                ...
                                                <table id="data-table-basic" class="table table-striped">
                                                    ...
                                                    <tbody>
                                                     ...
                                                     while($data = mysqli_fetch_array($result)) {
                                                        ...
                                                        echo "<td><a href='detailTugas.php?id=$data[id_tugas]'><button title='detail' class='btn btn-primary btn-sm fa fa-info'> detail </button>
                                                        <a href='editTugas.php?id=$data[id_tugas]'><button title='edit' class='btn btn-warning btn-sm fa fa-edit'> edit </button>
