                                    ...
                                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                        <div class="data-table-list">
                                            <div class="basic-tb-hd">
                                                <h3>Data Materi</h3>
                                                <a href="tambahMateri.php"><button class="btn btn-success fa fa-plus" title="tambah"> tambah materi</button></a>
                                            </div>
                                                ...
                                                <table id="data-table-basic" class="table table-striped">
                                                    ...
                                                    <tbody>
                                                     ...
                                                     while($data = mysqli_fetch_array($result)) {
                                                        ...
                                                        echo "<td><a href='detailMateri.php?id=$data[id_materi]'><button title='detail' class='btn btn-primary btn-sm fa fa-info'> detail </button>
                                                        <a href='editMateri.php?id=$data[id_materi]'><button title='edit' class='btn btn-warning btn-sm fa fa-edit'> edit </button>
