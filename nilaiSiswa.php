                        ...
                        <div class="row">
                            <div class="col-xl-12">
                                <div class="card card-info">
                                    ...
                                    if($r >= 90)
                                    {
                                        $k = "<button type='button' class='btn btn-success'>sangat baik</button>";
                                    }elseif($r >= 80 AND $r <= 90)
                                    {
                                        $k = "<button type='button' class='btn btn-success'>baik</button>";
                                    }elseif($r >= 70 AND $r <=80)
                                    {
                                        $k = "<button type='button' class='btn btn-success'>cukup</button>";
                                    }elseif($r <= 70 AND $r >= 50)
                                    {
                                        $k = "<button type='button' class='btn btn-warning'>kurang</button>";
                                    }elseif($r <= 50)
                                    {
                                        $k = "<button type='button' class='btn btn-danger'>mengulang</button>";
                                    }
                                    ?>
                                    <div class="card-footer">kategori <?php echo $k ?></div>
                                </div>
                            </div>
                        </div>
                    </section>
